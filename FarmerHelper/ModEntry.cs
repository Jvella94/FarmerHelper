...
namespace FarmerHelper
{
    ...
    public partial class ModEntry : Mod
    {
        ...
        private void GameLoop_GameLaunched(object sender, StardewModdingAPI.Events.GameLaunchedEventArgs e)
        {
            ...
            configMenu.AddBoolOption(
               mod: ModManifest,
               name: () => "Detailed Logging to Console?",
               getValue: () => Config.LoggingEnabled,
               setValue: value => Config.LoggingEnabled = value
           );
            configMenu.AddBoolOption(
                mod: ModManifest,
        ...
        private static readonly Season[] seasons = new Season[] { Season.Spring, Season.Summer, Season.Fall, Season.Winter };
        ...
        private static bool EnoughDaysLeft(Crop c, HoeDirt hoeDirt)
        {
            ...
            {
                HoeDirt d = new(hoeDirt.state.Value, c)
                {
                    Location = hoeDirt.Location,
                    Tile = hoeDirt.Tile
                };
